...
:breadcrumbs="[
    ...
    @if ($codigo->area->FK_Area_SedeId == 1)
                    ...
                    <h3 class=" font-semibold text-gray-900 dark:text-black">Estado del bien</h3>
                        <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">    
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                ...
                                @else
                                    <div class="flex items-center ps-3">
                                            <input  id="horizontal-list-radio-license" type="radio" value="Bueno" name="Testado_fisico_comentario" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="horizontal-list-radio-license" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bueno </label>
                                    </div>
                                @endif
                            </li>
    ...
    @else
        ...
        onsubmit="setTimeout(() => { window.location.href='{{ route('adminbien.index') }}'; }, 1000);">
            @csrf
                    ...
                    <h3 class=" font-semibold text-gray-900 dark:text-black">Estado del bien</h3>
                        <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">    
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                ...
                                @if ($codigo->Testado_fisico_hardware != "Bien")
                                    <div class="flex items-center ps-3">
                                        <input disabled id="horizontal-list-radio-license" type="radio" value="Bien" name="Testado_fisico_comentario" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            ...
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                ...
                                @if ($codigo->Testado_fisico_hardware != "Bien" &&  $codigo->Testado_fisico_hardware != "Regular" )
                                    <div class="flex items-center ps-3">
                                        <input disabled id="horizontal-list-radio-id" type="radio" value="Regular" name="Testado_fisico_comentario" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="horizontal-list-radio-id" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Regular </label>
                                    </div>
            ...
            <div class="grid gap-6 mb-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input name="usuario" type="text" id="usuario" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxlength="30"  required  placeholder="Ingrese el Host" required value="{{old('usuario')}}"/>
                    @error('usuario')
                            <p class="text-red-600">*{{$message}}</p>
                    @enderror
                </div>
