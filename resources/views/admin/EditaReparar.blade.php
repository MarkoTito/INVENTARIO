    ...
    <form method="POST" action="{{(route('admincomentario.update',$comentarios->PK_Comentario))}}" class="submit-form" target="_blank" 
        ...
        <div class="grid gap-6 mb-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input name="Tdoc_ref_comentario" type="text" id="usuario" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxlength="30"  required  placeholder="Escriba el documento el cual tendra relacion con el acta"  value="{{$comentarios->Tdoc_ref_comentario}}"/>
