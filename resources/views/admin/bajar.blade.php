...
:breadcrumbs="[
    ...
    <form action="/admin/Bajar/{{$code}}" class="delete-form">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div>
                {{-- tipo de contrato --}}
                <label for="contratro" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Tipo de contrato:</label>
                <input name="contratro" type="text" id="contratro" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxlength="100"  required  placeholder="Ingrese el tipo de contrato" required value="{{old('contratro')}}"/>
                @error('contratro')
                        <p class="text-red-600">*{{$message}}</p>
                @enderror
            </div>
