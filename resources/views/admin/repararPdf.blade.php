    ...
    onsubmit="setTimeout(() => { window.location.href='{{ route('adminbien.index') }}'; }, 2500);">
        ...
        <div class="grid gap-6 mb-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input name="usuario" type="text" id="usuario" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxlength="30"  required  placeholder="Nombre y apellidos del usuario" required value="{{old('usuario')}}"/>
                @error('usuario')
                        <p class="text-red-600">*{{$message}}</p>
                @enderror
            </div>
