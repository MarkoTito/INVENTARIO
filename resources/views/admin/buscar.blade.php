        ...
        <div>
            <form method="POST" action="/admin/buscar/todo" class="p-6 rounded-lg mx-auto inline-block">                
                ...
                <div class=" flex justify-center mt-4">
                    <input require checked id="default-radio-1" type="radio" value="1" name="estado" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-black">Activo</label>
                    <span class="text-white" >---</span>
                    <input require  id="default-radio-2" type="radio" value="0" name="estado" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        @if ( $bien->FK_Hardware_EstadoId == 1) 
                            ...
                            {{-- @if ($bien->FK_Hardware_SedeId == 1)
                                pertenece a palacio, osea no genera , certificado
                            ...
                            {{-- se puso para q toda reparacion genere su acta --}}
                            <th scope="row" class="px-6 py-4 font-medium  whitespace-nowra" align="center">
                                <a href="/admin/comentario/pdf/creacion/{{$bien->UK_Hardware_Codigo}}" class="text-black"  >
                                    <span class="w-6 h-6 inline-flex justify-center items-center">
                                        <i class="fa-solid fa-wrench"></i>
