      ...
      <ul class="space-y-2 font-medium">
        <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Licencia</a>
                  </li>
         ...
         <li>
            <li>
               ...
               <ul id="dropdown-buscar" class="hidden py-2 space-y-2">
                     <li>
                        <a href="{{route('adminbien.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Bien Activo</a>
                     </li>
                     <li>
                        <a href="/admin/buscar/baja/todo" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Bien Dado de Baja</a>
                     </li>
